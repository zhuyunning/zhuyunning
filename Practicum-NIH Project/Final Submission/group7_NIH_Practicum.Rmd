...
```{r, echo = FALSE}
if (pt1) {
  dat08 = read.csv('/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/NIGMS_R01_R37_93_08.csv',head=T,stringsAsFactors = FALSE) # read metadata
  dat08$Project.Start.Date = as.Date(dat08$Project.Start.Date,format='%d-%b-%y') # format date
  dat08$Project.End.Date   = as.Date(dat08$Project.End.Date,format='%d-%b-%y') # format date
  dat08$Budget.Start.Date  = as.Date(dat08$Budget.Start.Date,format='%d-%b-%y') # format date
  dat08$Budget.End.Date    = as.Date(dat08$Budget.End.Date,format='%d-%b-%y') # format date
  
  dat15 = read.csv('/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/NIGMS_R01_R37_09_15.csv',head=T,stringsAsFactors = FALSE) # read metadata
  ...
  carndat = read.csv('/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/carnfull.csv',head=T) # import the data with Carneige Classfication information
  ...
  save(dat,file='/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/analysis.data.RData')
  # save the dat into analysis.data.RData
} else {
  load('/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/analysis.data.RData')
...
if (pt2) {
  ...
  if (TRUE) {
    ...
    gaps98 = data.frame(PPID=NA,pjnum=NA,Gap.Length=-1,SY=NA,FY=NA,idea=NA,Carn15=NA,Status6=NA,Status12=NA,Status18=NA,Status24=NA,Status30=NA,Status36=NA,StatusAny=NA)[0,] # set the framework of the data based on 1998-01-01
      ...
      if (nrow(pjdat)>=2) { # if the numbre of records captures is larger than 1, there is at least one gap for that project number
        for (j in 1:(nrow(pjdat)-1)) { # if the project's project end data is larger than four years before 1998-01-01 but smaller than 1998-01-01 and its next budget start date is larger than 1998-01-01, then the project will have one gap record in our model data
          if (pjdat$Project.End.Date[j] < asof98 & pjdat$Project.End.Date[j] > (asof98-1461) & pjdat$Budget.Start.Date[j+1] > asof98) {
            ...
            gaps$Status6 = ifelse(pjdat$Budget.Start.Date[j+1] <= asof98+6*days.per.month,1,0) # judge whether one project re entered within 12 month after 1998-01-01  
...
#as of Jan 1 2002
  ...
  save(gaps98,gaps02,gaps06,file='/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/three.gapdats.RData')
} else {
  load('/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/three.gapdats.RData')
}
```
...
if (pt3) {
  ...
  save(gaps98,gaps02,gaps06,gapsAll,file='/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/four.gapdats.RData') # save the data of 1998, 2002, 2006 and all into one: four.gapdats.RData
} else {
  load('/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/four.gapdats.RData') # load the four.gapdats.RData
}
```
...
if (pt4) {
  ...
  save(init1,init2,file='/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/initial.models.RData')
  ...
  save(coefstable,ptable,file='/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/final.model.outputs.RData') # save the outcome to final.model.ouputs.RData
} else {
  load('/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/final.model.outputs.RData') # load final.model.outputs.RData
  cf = coefstable
...
fAnyprob(gaps10$Gap.Length[x],gaps10$SY[x],gaps10$FY[x],gaps10$Num.Concurrent[x]))
  ...
  save(gaps10,valtab,file='/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/validation.RData')
} else {
  load('/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/validation.RData')
}
```
...
if (pt6) {
  ...
  if (TRUE) {
    ...
    save(scaledcoefstable,file='/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/scaled.coefficients.RData')
    write.csv(round(scaledcoefstable,2),file='/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/scaled.coefficients.csv',row.names=T)
  }
  
  #pred vs re-entry
  if (TRUE) {
    #predd12 vs re-entry
    png('/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/pred12.vs.re-entry.boxplots.png')
    ...
    #predd24 vs re-entry
    png('/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/pred24.vs.re-entry.boxplots.png')
    ...
    #predAny vs re-entry
    png('/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/predAny.vs.re-entry.boxplots.png')
  ...
  if (TRUE) {
    ...
    png('/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/pred12.vs.gaplength.png')
    ...
    png('/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/pred24.vs.gaplength.png')
    ...
    png('/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/predAny.vs.gaplength.png')
  ...
  if (TRUE) {
    #pred12 vs SY
    png('/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/pred12.vs.SY.png')
    ...
    #predAny vs SY
    png('/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/predAny.vs.SY.png')
  ...
  png('/Users/lijingning/Desktop/A/PRACTICUM/NIH/model_2/validation.plot.png')
