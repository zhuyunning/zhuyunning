#########################################################################
# Assignment 4
# Q1:  Our understanding of ERGM and the explanations that were provided
#      in the worksheet.
# Answer:  Exponential Random Graph Models are useful in understanding social 
#          structures. The model for an adjacency matrix is a weighted sum
#          of counts of ties, counts of triads, and a normalizing constant.
#          The ERGM coefficients are good indicators that we can use to describe
#          a social network.
# Q2:  How will you be able to use the techniques in your group projects?
# Answer:  We will definitely employ the Exponential Random Graph Modeling
#          technique in our group projects.  We will apply it to our matrices
#          and find the best summary of model fit that describes our networks.
#
